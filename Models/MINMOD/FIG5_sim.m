...
%%%%%%%% FIG. 3 Control 3
init=[90.68, 0, 4.55, 1153.70, -0.02788, 322.6, 0.6, 1, 29, 195.59]; % IC, sigma=322.6, si=0.6 
...
init=[90.68, 0, 4.55, 1153.70, -0.02788, 322, 0.6, 1, 29, 195.59]; % IC ,sigma=322.6, si=0.6
odeparams.IVGTT=0;
odeparams.OGTT=0;
odeparams.meal=1;
odeparams.Ginj=0;
