...
Large_sigma_clamp_si=[0.05833695 0.09814239  0.1365  0.17472952];% from Iclamp sim
...
hold('on')
scatter(input_si,Large_sigma_clamp_si, 'r', 'linewidth',lw)

lh=legend('Control','Large sigma','location','northwest');
set(lh,'FontSize',8); 
legend('boxoff');
